...
namespace BH.Engine.S_Frame
{
    public static partial class Convert
    {
        ...
        public static string ToS_Frame(this SConcreteModel model, SConcreteConfig config)
        {
            ...
            double Luyy = model.LengthYY;
            double Luzz = model.LengthZZ;
            ...
            string data =
                $"Codes	 {codes}	Units	 {units}	Bar Type	 {bar_type}	Maximum	 1	Simple	 True	ThetaIn	 0	UtilNoReinf	 .05	ApplyImprfct	 False	ReducedSHorzMax	 False	Text10	Value10	Text11	Value11	Member Name	{memberName}	Job Number	A123.45	Member Type	 2	Member Status	 2	Initialize Reinf	 True	Report Check 1	 True	Report Check 2	 True	Report Check 3	 True	Report Check 4	 True	Report Check 5	 True	Report Check 6	 True	Report Check 7	 True	Report Check 8	 True	Report Check 9	 True	Ignore Nf	 False	Orientation	 0	ClosedBeams	 True	Closed	 True	Bm b	 {bm_b}" + Environment.NewLine
                + $"Bm h	 {bm_h}	Bm bf	 {bm_bf}	Bm hf	 {bm_hf}	Bm IgnoreFlange	 False	Bm Top	 40	Bm Bottom	 40	Bm Side	 40	Bm CheckCracks	 True	Bm CheckBarS	 True	Bm Dstir	 3	Bm Sstir	 200	Bm StirHook	 135	Bm StirHook1	 135	Bm ApplyStir	 True	Bm ShowStir	 True	Bm NlegsZ	 2	Bm NlegsY	 2	Bm NlegsZreqd	 0	Bm DoubleStir	 False	Bm NbmFace	 4	Bm DbmFace	 4	Bm SbmFace	 180	Bm ZbmFace	 210	Bm ApplyFace	 True	Bm ApplyFaceNvsM	 True	Bm NfaceCurtains	 2	Bm Exposure	 0	Bm CoatTop	 0	Bm CoatBot	 0	Bm Show2ndT	 True" + Environment.NewLine
                ...
                + $"Bm DT(1,4)	 7	Bm DT(1,5)	 7	Bm DT(2,1)	 7	Bm DT(2,2)	 7	Bm DT(2,3)	 7	Bm DT(2,4)	 7	Bm DT(2,5)	 7	Bm DB(1,1)	 7	Bm DB(1,2)	 7	Bm DB(1,3)	 7	Bm DB(1,4)	 7	Bm DB(1,5)	 7	Bm DB(2,1)	 7	Bm DB(2,2)	 7	Bm DB(2,3)	 7	Bm DB(2,4)	 7	Bm DB(2,5)	 7	Cm bcol	 {cm_bcol}	Cm hcol	 {cm_hcol}	Cm D	 {cm_D}	Cm Cover	 40	Cm CoverInside	 40	Cm ApplyMinM	 True	Cm Do1Pcnt	 False	Cm NrClause	 4	Cm HoleType	 0	Cm bcolHole	 50	Cm hcolHole	 50	Cm DcolHole	 50	Cm ApplySteelSect	 False" + Environment.NewLine
