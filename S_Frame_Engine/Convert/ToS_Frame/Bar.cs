...
namespace BH.Engine.S_Frame
{
    public static partial class Convert
    {
        ...
        /**** Public Methods                            ****/
        /***************************************************/
        public static MemberType GetMemberType(Bar bar)
        {
        ...
        public static string GetSectionData(Bar bar)
        {
            ConcreteSection section = (ConcreteSection)bar.SectionProperty;
            if (bar.IsVertical())
            {
                try
                {
                    return GetColumnProfileData(section.SectionProfile as dynamic);
                }
                catch
                {
                    return "";
            ...
            else
            {
                try
                {
                    return GetBeamProfileData(section.SectionProfile as dynamic);
                }
                catch
                {
                    return "";
        ...
        public static string GetBeamProfileData(RectangleProfile profile)
        {
            string memberType = MemberType.RectBeam.ToString("D");
            string h = (profile.Height * 1000).ToString("0");
            string b = (profile.Width * 1000).ToString("0");
            string memberName = profile.Name;

            string data =
                $"Codes	 17	Units	 1	Bar Type	 2	Maximum	 1	Simple	 True	ThetaIn	 0	UtilNoReinf	 .05	ApplyImprfct	 False	ReducedSHorzMax	 False	Text10	Value10	Text11	Value11	Member Name	{memberName}	Job Number	A123.45	Member Type	 {memberType}	Member Status	 2	Initialize Reinf	 True	Report Check 1	 True	Report Check 2	 True	Report Check 3	 True	Report Check 4	 True	Report Check 5	 True	Report Check 6	 True	Report Check 7	 True	Report Check 8	 True	Report Check 9	 True	Ignore Nf	 False	Orientation	 0	ClosedBeams	 True	Closed	 True	Bm b	 {b}" + Environment.NewLine
                + $"Bm h	 {h}	Bm bf	 1500	Bm hf	 125	Bm IgnoreFlange	 False	Bm Top	 40	Bm Bottom	 40	Bm Side	 40	Bm CheckCracks	 True	Bm CheckBarS	 True	Bm Dstir	 3	Bm Sstir	 200	Bm StirHook	 135	Bm StirHook1	 135	Bm ApplyStir	 True	Bm ShowStir	 True	Bm NlegsZ	 2	Bm NlegsY	 2	Bm NlegsZreqd	 0	Bm DoubleStir	 False	Bm NbmFace	 4	Bm DbmFace	 4	Bm SbmFace	 180	Bm ZbmFace	 210	Bm ApplyFace	 True	Bm ApplyFaceNvsM	 True	Bm NfaceCurtains	 2	Bm Exposure	 0	Bm CoatTop	 0	Bm CoatBot	 0	Bm Show2ndT	 True" + Environment.NewLine
        ...
        public static string GetBeamProfileData(TSectionProfile profile)
        {
            string memberType = MemberType.TBeam.ToString("D");
            string h = (profile.Height * 1000).ToString("0");
            string b = (profile.WebThickness * 1000).ToString("0");
            string bf = (profile.Width * 1000).ToString("0");
            string hf = (profile.FlangeThickness * 1000).ToString("0");
            string memberName = profile.Name;
            ...
            string data =
                ...
                + $"Bm h	 {h}	Bm bf	 {bf}	Bm hf	 {hf}	Bm IgnoreFlange	 False	Bm Top	 40	Bm Bottom	 40	Bm Side	 40	Bm CheckCracks	 True	Bm CheckBarS	 True	Bm Dstir	 3	Bm Sstir	 200	Bm StirHook	 135	Bm StirHook1	 135	Bm ApplyStir	 True	Bm ShowStir	 True	Bm NlegsZ	 2	Bm NlegsY	 2	Bm NlegsZreqd	 0	Bm DoubleStir	 False	Bm NbmFace	 4	Bm DbmFace	 4	Bm SbmFace	 180	Bm ZbmFace	 210	Bm ApplyFace	 True	Bm ApplyFaceNvsM	 True	Bm NfaceCurtains	 2	Bm Exposure	 0	Bm CoatTop	 0	Bm CoatBot	 0	Bm Show2ndT	 True" + Environment.NewLine
                + "Bm Show2ndB	 True	Bm SameDTop	 True	Bm SameDBot	 True	Bm dzT	 25.4	Bm dzB	 25.4	Bm ComputedzT	 True	Bm ComputedzB	 True	Bm NT(1,1)	 2	Bm NT(1,2)	 0	Bm NT(1,3)	 0	Bm NT(1,4)	 0	Bm NT(1,5)	 0	Bm NT(2,1)	 3	Bm NT(2,2)	 0	Bm NT(2,3)	 0	Bm NT(2,4)	 0	Bm NT(2,5)	 0	Bm NB(1,1)	 2	Bm NB(1,2)	 0	Bm NB(1,3)	 0	Bm NB(1,4)	 0	Bm NB(1,5)	 0	Bm NB(2,1)	 2	Bm NB(2,2)	 0	Bm NB(2,3)	 0	Bm NB(2,4)	 0	Bm NB(2,5)	 0	Bm DT(1,1)	 7	Bm DT(1,2)	 7	Bm DT(1,3)	 7" + Environment.NewLine
                + "Bm DT(1,4)	 7	Bm DT(1,5)	 7	Bm DT(2,1)	 7	Bm DT(2,2)	 7	Bm DT(2,3)	 7	Bm DT(2,4)	 7	Bm DT(2,5)	 7	Bm DB(1,1)	 7	Bm DB(1,2)	 7	Bm DB(1,3)	 7	Bm DB(1,4)	 7	Bm DB(1,5)	 7	Bm DB(2,1)	 7	Bm DB(2,2)	 7	Bm DB(2,3)	 7	Bm DB(2,4)	 7	Bm DB(2,5)	 7	Cm bcol	 450	Cm hcol	 550	Cm D	 600	Cm Cover	 40	Cm CoverInside	 40	Cm ApplyMinM	 True	Cm Do1Pcnt	 False	Cm NrClause	 4	Cm HoleType	 0	Cm bcolHole	 50	Cm hcolHole	 50	Cm DcolHole	 50	Cm ApplySteelSect	 False" + Environment.NewLine
                + "Cm Nzcol	 5	Cm Nycol	 5	Cm Nface1	 8	Cm Nface2	 6	Cm Nface1draw	 0	Cm Nface2draw	 0	Cm DVert	 7	Cm DVert2	 7	Cm DHorz	 3	Cm DHorz2	 3	Cm NClegsZ	 2	Cm NClegsY	 2	Cm TieHook	 135	Cm CrossHook	 135	Cm NLayers	 1	Cm Apply2ndLayer	 False	Cm ApplyDiamond	 True	Cm TieReinf	 0	Cm Splice	 0	Cm dlayer	 38.1	Cm ComputeDlayer	 True	Cm Stie	 200	Cm Stie2	 200	Cm Pitch	 50	Cm Pitch2	 50	Cm SteelSectTable	 2	Cm SteelSectNo	 191	Cm SteelSectName	W14X61	Cm WWFd	 352.806	Cm WWFb	 253.873" + Environment.NewLine
                + "Cm WWFt	 16.383	Cm WWFw	 9.525	Wa CoverW	 40	Wa CoverZ	 40	Wa Npanels	 0	Wa Offset	 600	Wa Symmetric	 False	Wa Rectangular	 False	Wa AddWall	 True	Wa VertOut	 False	Wa DoNomProb	 True	Wa L2	 600	Wa T2	 400	Wa L3	 750	Wa T3	 500	Slender	 False	NomStfnsSlndr	 True	CoMomDFyy	 8	CoMomDFzz	 8	CcvtrDFyy	 8	CcvtrDFzz	 8	LuYY	 3000	LuZZ	 3000	ky	 1	kz	 1	kEcIg	 .25	Bm hIncr	 50	Bm bIncr	 25	Cm hcolIncr	 50	Cm bcolIncr	 50" + Environment.NewLine
        ...
        public static string GetBeamProfileData(AngleProfile profile)
        {
            string memberType = MemberType.LBeam.ToString("D");
            string h = (profile.Height * 1000).ToString("0");
            string b = (profile.WebThickness * 1000).ToString("0");
            string bf = (profile.Width * 1000).ToString("0");
            string hf = (profile.FlangeThickness * 1000).ToString("0");
        ...
        public static string GetColumnProfileData(RectangleProfile profile)
        {
            ...
            string data =
                ...
                + "Bm Show2ndB	 True	Bm SameDTop	 True	Bm SameDBot	 True	Bm dzT	 25.4	Bm dzB	 25.4	Bm ComputedzT	 True	Bm ComputedzB	 True	Bm NT(1,1)	 2	Bm NT(1,2)	 0	Bm NT(1,3)	 0	Bm NT(1,4)	 0	Bm NT(1,5)	 0	Bm NT(2,1)	 3	Bm NT(2,2)	 0	Bm NT(2,3)	 0	Bm NT(2,4)	 0	Bm NT(2,5)	 0	Bm NB(1,1)	 2	Bm NB(1,2)	 0	Bm NB(1,3)	 0	Bm NB(1,4)	 0	Bm NB(1,5)	 0	Bm NB(2,1)	 2	Bm NB(2,2)	 0	Bm NB(2,3)	 0	Bm NB(2,4)	 0	Bm NB(2,5)	 0	Bm DT(1,1)	 7	Bm DT(1,2)	 7	Bm DT(1,3)	 7" + Environment.NewLine
                + $"Bm DT(1,4)	 7	Bm DT(1,5)	 7	Bm DT(2,1)	 7	Bm DT(2,2)	 7	Bm DT(2,3)	 7	Bm DT(2,4)	 7	Bm DT(2,5)	 7	Bm DB(1,1)	 7	Bm DB(1,2)	 7	Bm DB(1,3)	 7	Bm DB(1,4)	 7	Bm DB(1,5)	 7	Bm DB(2,1)	 7	Bm DB(2,2)	 7	Bm DB(2,3)	 7	Bm DB(2,4)	 7	Bm DB(2,5)	 7	Cm bcol	 {b}	Cm hcol	 {h}	Cm D	 600	Cm Cover	 40	Cm CoverInside	 40	Cm ApplyMinM	 True	Cm Do1Pcnt	 False	Cm NrClause	 4	Cm HoleType	 0	Cm bcolHole	 50	Cm hcolHole	 50	Cm DcolHole	 50	Cm ApplySteelSect	 False" + Environment.NewLine
                + "Cm Nzcol	 5	Cm Nycol	 5	Cm Nface1	 8	Cm Nface2	 6	Cm Nface1draw	 0	Cm Nface2draw	 0	Cm DVert	 7	Cm DVert2	 7	Cm DHorz	 3	Cm DHorz2	 3	Cm NClegsZ	 2	Cm NClegsY	 2	Cm TieHook	 135	Cm CrossHook	 135	Cm NLayers	 1	Cm Apply2ndLayer	 False	Cm ApplyDiamond	 True	Cm TieReinf	 0	Cm Splice	 0	Cm dlayer	 38.1	Cm ComputeDlayer	 True	Cm Stie	 200	Cm Stie2	 200	Cm Pitch	 50	Cm Pitch2	 50	Cm SteelSectTable	 2	Cm SteelSectNo	 191	Cm SteelSectName	W14X61	Cm WWFd	 352.806	Cm WWFb	 253.873" + Environment.NewLine
                + "Cm WWFt	 16.383	Cm WWFw	 9.525	Wa CoverW	 40	Wa CoverZ	 40	Wa Npanels	 0	Wa Offset	 600	Wa Symmetric	 False	Wa Rectangular	 False	Wa AddWall	 True	Wa VertOut	 False	Wa DoNomProb	 True	Wa L2	 600	Wa T2	 400	Wa L3	 750	Wa T3	 500	Slender	 False	NomStfnsSlndr	 True	CoMomDFyy	 8	CoMomDFzz	 8	CcvtrDFyy	 8	CcvtrDFzz	 8	LuYY	 3000	LuZZ	 3000	ky	 1	kz	 1	kEcIg	 .25	Bm hIncr	 50	Bm bIncr	 25	Cm hcolIncr	 50	Cm bcolIncr	 50" + Environment.NewLine
                + "Cm Dincr	 50	Cm HoleIncr	 25	Bm bfIncr	 100	Bm hfIncr	 10	Wa Lincr	 50	Wa Tincr	 25	fyIncr	 50	fcuIncr	 5	Bm StirIncr	 25	Bm FaceIncr	 10	Cm TieIncr	 25	Cm PitchIncr	 10	Wa ZoneVertSIncr	 25	Wa ZoneTieSIncr	 25	Wa PanelSincr	 50	ScaleBarWidth	 True	fy	 413.6854	fy2	 413.6854	fy3	 344.7379	Wc	 2402.769	Ws	 8009.229	Poisson	 .2	hagg	 19.05	Gc	 12315.26	Ec	 29556.62	Es	 199948	kIe	 1	kAe	 1	kAse	 1	kJe	 1" + Environment.NewLine
                + "MaxIter	 25	fyDesMin	 100	fyDesMax	 1000	fy2DesMin	 100	fy2DesMax	 1000	fy3DesMin	 100	fy3DesMax	 1000	fcuDesMin	 5	fcuDesMax	 100	Freezefy	 True	Freezefy2	 True	Freezefy3	 True	Freezefcu	 True	Bm Bmbovrh	 .7	Bm bmin	 125	Bm bmax	 10000	Bm hmin	 150	Bm hmax	 10000	Bm Freezeb	 False	Bm Freezeh	 False	Bm dbTopMin	 11	Bm dbTopMax	 35	Bm dbBotMin	 11	Bm dbBotMax	 35	Bm dbStirMin	 11	Bm dbStirMax	 20	Bm dbFaceMin	 16	Bm dbFaceMax	 25	Bm FreezeTop	 False	Bm FreezeBot	 False" + Environment.NewLine
        ...
        public static string GetColumnProfileData(CircleProfile profile)
        {
            string memberType = MemberType.RectColumn.ToString("D");
            string d = (profile.Diameter * 1000).ToString("0");
            string memberName = profile.Name;
            ...
            string data =
                ...
                + $"Bm h	 600	Bm bf	 1500	Bm hf	 125	Bm IgnoreFlange	 False	Bm Top	 40	Bm Bottom	 40	Bm Side	 40	Bm CheckCracks	 True	Bm CheckBarS	 True	Bm Dstir	 3	Bm Sstir	 200	Bm StirHook	 135	Bm StirHook1	 135	Bm ApplyStir	 True	Bm ShowStir	 True	Bm NlegsZ	 2	Bm NlegsY	 2	Bm NlegsZreqd	 0	Bm DoubleStir	 False	Bm NbmFace	 4	Bm DbmFace	 4	Bm SbmFace	 180	Bm ZbmFace	 210	Bm ApplyFace	 True	Bm ApplyFaceNvsM	 True	Bm NfaceCurtains	 2	Bm Exposure	 0	Bm CoatTop	 0	Bm CoatBot	 0	Bm Show2ndT	 True" + Environment.NewLine
                + "Bm Show2ndB	 True	Bm SameDTop	 True	Bm SameDBot	 True	Bm dzT	 25.4	Bm dzB	 25.4	Bm ComputedzT	 True	Bm ComputedzB	 True	Bm NT(1,1)	 2	Bm NT(1,2)	 0	Bm NT(1,3)	 0	Bm NT(1,4)	 0	Bm NT(1,5)	 0	Bm NT(2,1)	 3	Bm NT(2,2)	 0	Bm NT(2,3)	 0	Bm NT(2,4)	 0	Bm NT(2,5)	 0	Bm NB(1,1)	 2	Bm NB(1,2)	 0	Bm NB(1,3)	 0	Bm NB(1,4)	 0	Bm NB(1,5)	 0	Bm NB(2,1)	 2	Bm NB(2,2)	 0	Bm NB(2,3)	 0	Bm NB(2,4)	 0	Bm NB(2,5)	 0	Bm DT(1,1)	 7	Bm DT(1,2)	 7	Bm DT(1,3)	 7" + Environment.NewLine
                + $"Bm DT(1,4)	 7	Bm DT(1,5)	 7	Bm DT(2,1)	 7	Bm DT(2,2)	 7	Bm DT(2,3)	 7	Bm DT(2,4)	 7	Bm DT(2,5)	 7	Bm DB(1,1)	 7	Bm DB(1,2)	 7	Bm DB(1,3)	 7	Bm DB(1,4)	 7	Bm DB(1,5)	 7	Bm DB(2,1)	 7	Bm DB(2,2)	 7	Bm DB(2,3)	 7	Bm DB(2,4)	 7	Bm DB(2,5)	 7	Cm bcol	 450	Cm hcol	 550	Cm D	 {d}	Cm Cover	 40	Cm CoverInside	 40	Cm ApplyMinM	 True	Cm Do1Pcnt	 False	Cm NrClause	 4	Cm HoleType	 0	Cm bcolHole	 50	Cm hcolHole	 50	Cm DcolHole	 50	Cm ApplySteelSect	 False" + Environment.NewLine
                + "Cm Nzcol	 5	Cm Nycol	 5	Cm Nface1	 8	Cm Nface2	 6	Cm Nface1draw	 0	Cm Nface2draw	 0	Cm DVert	 7	Cm DVert2	 7	Cm DHorz	 3	Cm DHorz2	 3	Cm NClegsZ	 2	Cm NClegsY	 2	Cm TieHook	 135	Cm CrossHook	 135	Cm NLayers	 1	Cm Apply2ndLayer	 False	Cm ApplyDiamond	 True	Cm TieReinf	 0	Cm Splice	 0	Cm dlayer	 38.1	Cm ComputeDlayer	 True	Cm Stie	 200	Cm Stie2	 200	Cm Pitch	 50	Cm Pitch2	 50	Cm SteelSectTable	 2	Cm SteelSectNo	 191	Cm SteelSectName	W14X61	Cm WWFd	 352.806	Cm WWFb	 253.873" + Environment.NewLine
                + "Cm WWFt	 16.383	Cm WWFw	 9.525	Wa CoverW	 40	Wa CoverZ	 40	Wa Npanels	 0	Wa Offset	 600	Wa Symmetric	 False	Wa Rectangular	 False	Wa AddWall	 True	Wa VertOut	 False	Wa DoNomProb	 True	Wa L2	 600	Wa T2	 400	Wa L3	 750	Wa T3	 500	Slender	 False	NomStfnsSlndr	 True	CoMomDFyy	 8	CoMomDFzz	 8	CcvtrDFyy	 8	CcvtrDFzz	 8	LuYY	 3000	LuZZ	 3000	ky	 1	kz	 1	kEcIg	 .25	Bm hIncr	 50	Bm bIncr	 25	Cm hcolIncr	 50	Cm bcolIncr	 50" + Environment.NewLine
                + "Cm Dincr	 50	Cm HoleIncr	 25	Bm bfIncr	 100	Bm hfIncr	 10	Wa Lincr	 50	Wa Tincr	 25	fyIncr	 50	fcuIncr	 5	Bm StirIncr	 25	Bm FaceIncr	 10	Cm TieIncr	 25	Cm PitchIncr	 10	Wa ZoneVertSIncr	 25	Wa ZoneTieSIncr	 25	Wa PanelSincr	 50	ScaleBarWidth	 True	fy	 413.6854	fy2	 413.6854	fy3	 344.7379	Wc	 2402.769	Ws	 8009.229	Poisson	 .2	hagg	 19.05	Gc	 12315.26	Ec	 29556.62	Es	 199948	kIe	 1	kAe	 1	kAse	 1	kJe	 1" + Environment.NewLine
                + "MaxIter	 25	fyDesMin	 100	fyDesMax	 1000	fy2DesMin	 100	fy2DesMax	 1000	fy3DesMin	 100	fy3DesMax	 1000	fcuDesMin	 5	fcuDesMax	 100	Freezefy	 True	Freezefy2	 True	Freezefy3	 True	Freezefcu	 True	Bm Bmbovrh	 .7	Bm bmin	 125	Bm bmax	 10000	Bm hmin	 150	Bm hmax	 10000	Bm Freezeb	 False	Bm Freezeh	 False	Bm dbTopMin	 11	Bm dbTopMax	 35	Bm dbBotMin	 11	Bm dbBotMax	 35	Bm dbStirMin	 11	Bm dbStirMax	 20	Bm dbFaceMin	 16	Bm dbFaceMax	 25	Bm FreezeTop	 False	Bm FreezeBot	 False" + Environment.NewLine
